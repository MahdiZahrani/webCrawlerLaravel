...
function getProduct(id) {
  $.LoadingOverlay("show");
  $.ajax({
    url: "/product/".concat(typeof id !== 'undefined' ? "".concat(id) : ''),
    type: 'GET',
...
module.exports = __webpack_require__(/*! /srv/http/webCrawlerLaravel/resources/js/store.js */"./resources/js/store.js");
